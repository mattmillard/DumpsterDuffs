...
export default function AdminSettingsPage() {
  ...
  const missingRequired = envRows.filter(
    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-[#999999] mt-2">
            Manage registered users and monitor system health
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
          <div>
            ...
            <p className="text-[#999999] text-sm mt-1">
              Promote registered accounts to admin access without opening
              Supabase
            </p>
          </div>
          <input
        ...
        {usersLoading ? (
          ...
          <div className="overflow-x-auto">
            ...
            {filteredUsers.length === 0 && (
              <p className="text-[#999999] text-sm py-4">
      ...
      <section className="bg-[#1A1A1A] border border-[#404040] rounded-lg p-6 space-y-4">
        <div>
          ...
          <p className="text-[#999999] text-sm mt-1">
            Quick environment checks to catch deployment misconfiguration
          </p>
        </div>
            ...
            {!health.services.database.reachable && (
              <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-3">
                <p className="text-red-300 text-sm">
                  ...
                  {health.services.database.error || "Unknown error"}
                </p>
              </div>
            )}
