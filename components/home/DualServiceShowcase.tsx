      ...
      <div className="container-custom">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-[#999999] text-balance">
            Whether you prefer to load it yourself or want professional service,
            Dumpster Duff has your solution
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-[#262626] rounded-xl p-8 border border-[#404040] hover:border-primary/50 transition-colors">
            ...
            <p className="text-[#999999] mb-6">
              You fill it, we haul it. Perfect for bathroom renovations, garage
              cleanouts, and weekend projects.
            </p>
            ...
            <ul className="space-y-3 mb-6">
              <li className="flex items-start gap-3">
                ...
                <span className="text-[#999999]">
                  15-yard size handles most projects
                </span>
              </li>
              <li className="flex items-start gap-3">
                <svg
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="text-[#999999]">
                  Included disposal for up to 2 tons
                </span>
              </li>
            </ul>
          ...
          <div className="bg-[#262626] rounded-xl p-8 border border-[#404040] hover:border-primary/50 transition-colors">
            ...
            <p className="text-[#999999] mb-6">
              We handle everything. Basement cleanouts, estate sales, storm
              debris—no lifting required.
            </p>
        ...
        <div className="bg-gradient-to-r from-[#0F0F0F] to-[#1A1A1A] rounded-xl p-8 border border-[#404040] text-center">
          ...
          <p className="text-[#999999] mb-6">
            <strong className="text-white">Call Duff & Ditch Your Stuff</strong>
            —we'll help you choose the perfect solution
          </p>
