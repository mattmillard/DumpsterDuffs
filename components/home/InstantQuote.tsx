...
export default function InstantQuote() {
  ...
  return (
    <section id="book-now" className="section-padding bg-white">
      <div className="container-custom">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="card p-6 md:p-8 bg-gradient-to-br from-primary/5 to-accent/5">
            ...
            {/* Estimate Display */}
            {showEstimate && (
              <div className="mt-6 p-6 bg-white rounded-lg border-2 border-success">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-baseline gap-2 mb-4">
                      ...
                      <span className="text-gray-600">for up to 7 days</span>
                    </div>
