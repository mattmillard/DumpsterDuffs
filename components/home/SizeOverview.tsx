        ...
        <div className="max-w-5xl mx-auto">
          <div className="card overflow-hidden">
            <div className="grid md:grid-cols-2 gap-0">
              {/* Left: Visual */}
              <div className="bg-gradient-to-br from-primary/10 to-accent/10 p-8 flex flex-col items-center justify-center">
                ...
                {/* Price Badge */}
                <div className="mt-6 bg-white rounded-lg shadow-md px-6 py-4 text-center">
                  <p className="text-sm text-gray-600">Starting at</p>
                  <p className="text-4xl font-bold text-primary">
                    {dumpsterInfo.price}
                  </p>
                  <p className="text-sm text-gray-600 mt-1">7-day rental</p>
                </div>
              </div>
              ...
              <div className="p-8">
                <div className="flex items-baseline gap-3 mb-4">
                  ...
                  <span className="text-lg text-gray-600">Dumpster</span>
                </div>
